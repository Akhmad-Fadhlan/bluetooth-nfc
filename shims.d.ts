...
declare namespace bluetooth {
    ...
    function __log(priority: int32, msg: string): void;
     ...
     */
    //% shim=bluetooth::uartWriteString
    function uartWriteString(data: string): void;

    /**
     * Reads from the Bluetooth UART service buffer until a delimiter.
     */
    //% shim=bluetooth::uartReadUntil
